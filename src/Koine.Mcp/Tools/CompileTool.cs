...
public static class CompileTool
{
    ...
    [Description("""
        ...
        csharp (default), typescript, glossary, or docs. Multi-file models compile together. If the
        model has semantic errors, no files are produced and `diagnostics` explains why — fix them
        (koine_validate shows the same diagnostics) and retry. Returns { success, errorCount,
