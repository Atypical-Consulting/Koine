...
public static class CompileTool
{
    ...
    [Description("""
        ...
        csharp (default), typescript, python, php, rust, java, kotlin, glossary, docs, asyncapi, or openapi. Multi-file models compile together.
    ...
    public static CompilationResult Compile(
        ...
        KoineFile[] files,
        [Description("Output target: csharp (default), typescript, python, php, rust, java, kotlin, glossary, docs, asyncapi, or openapi.")]
