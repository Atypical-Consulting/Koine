...
|--------- |-------- |------------:|----------:|----------:|------------:|------:|--------:|---------:|---------:|-----------:|------------:|
| **Parse**    | **Billing** |    **51.81 μs** |  **0.913 μs** |  **0.810 μs** |    **51.70 μs** |  **0.35** |    **0.01** |  **15.9302** |   **3.0518** |   **97.89 KB** |        **0.28** |
| Diagnose | Billing |    67.06 μs |  1.334 μs |  2.538 μs |    65.94 μs |  0.46 |    0.02 |  21.3623 |   3.0518 |  131.14 KB |        0.38 |
| Compile  | Billing |   147.42 μs |  2.931 μs |  4.649 μs |   148.38 μs |  1.00 |    0.04 |  56.6406 |   9.5215 |  348.49 KB |        1.00 |
|          |         |             |           |           |             |       |         |          |          |            |             |
| **Parse**    | **Shop**    |   **726.82 μs** | **14.347 μs** | **21.030 μs** |   **726.33 μs** |  **0.38** |    **0.02** | **193.3594** |  **65.4297** | **1188.43 KB** |        **0.45** |
| Diagnose | Shop    |   991.11 μs | 19.415 μs | 32.438 μs | 1,000.14 μs |  0.52 |    0.03 | 238.2813 |  83.9844 |  1459.9 KB |        0.55 |
| Compile  | Shop    | 1,896.49 μs | 37.148 μs | 68.857 μs | 1,901.60 μs |  1.00 |    0.05 | 429.6875 | 152.3438 | 2639.26 KB |        1.00 |
