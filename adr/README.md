...
| [0017](0017-publish-is-a-distinct-clause-from-emit.md) | A command publishes an integration event through a distinct `publish` clause, not a widened `emit` | Proposed |
