...
| `service … usecase …`, `readmodel`, `query`, `@route`/`@auth` | application services, CQRS read models and queries, the HTTP surface of a command, query or factory | [Application layer & CQRS](/Koine/reference/application-cqrs/) |
