...
public class FlatModelIndexLookupGuardTests
{
    ...
    [
        ...
        ("src/Koine.Execution/ScenarioExecutor.cs", 1540, "TryGetDecl", "final fallback within a DeclaringContextsOf/TryGetDeclIn walk in InvariantsDeclaredOn"),
        ...
        ("src/Koine.Emit.Rust/RustEmitter.Entities.cs", 816, "Classify", "BuildFactoryCtorArgs (required loop): translator.Context available, unused (#1870)"),
        ("src/Koine.Emit.Rust/RustEmitter.Entities.cs", 847, "Classify", "BuildFactoryCtorArgs (defaulted loop): translator.Context available, unused (#1870)"),
        ("src/Koine.Emit.Rust/RustEmitter.Entities.cs", 908, "Classify", "TransitionEnum: context available only at its sole caller, not threaded in (#1870)"),
